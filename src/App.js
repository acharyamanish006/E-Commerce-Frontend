...
function App() {
  ...
  const [products,setproducts] = useState( [
    {
      ...
      price:1690,
      image:"https://static-01.daraz.com.np/p/fba0c6ae25685b28e758e68c8282f98e.jpg",
      rating:4.5
    },
    {
      id:2,
      ...
      description:"Machine wash Independently with mildwith domestic and imported materialsDo not bleach Do not dry cleanPlease refer to the size chart in the picture before placing an order to ensure that the waist are suitable. Since your order will not display your size information, please size carefully before placing your order! If you need help, please contact our customer service.",
      price:2000,
      image:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ7ZkZIP4lJSm7EzOcvOaIB0v3YjTn1ixzS7aheIRc&s",
      rating:4
    },
    {
      id:3,
  ...
  return (
    <div className='container' >
      <BrowserRouter>
      {isAuthenticated ? <Navbar products={products} setproducts={setproducts}/> : null}
      <Routes>
        <Route element={<ProtectedRoutes isAuthenticated={isAuthenticated} />}>
          <Route path='/' index element={ isloading ? <Loader/>: <Home products ={products}/> }/>
          <Route path='/product/:productId'  element={ isloading ? <Loader/>: <ProductDetails products={products}/> }/>
        </Route>
